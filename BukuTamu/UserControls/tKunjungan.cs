...
{
    public partial class tKunjungan : UserControl
    {
        ...
        private void btSelesai_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                else if (tbNama.Text != "" && tbInstansi.Text != "" && tbEmail.Text != "" && tbHp.Text != "" && tbJumlah.Text != "")
                {
                    try
                    {
                        ...
                        command.CommandText = "INSERT INTO tb_kunjungan(nama_kunjungan, intansi, email, no_np, ttd, jumlah_tamu, foto) VALUE (@nama, @instansi, @email, @no_hp, @ttd, @jumlah, @foto)";
                        conn.Open();
                        ...
                        MessageBox.Show("Berhasil Mengisi Form Tamu Kunjungan", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void tKunjungan_Load(object sender, EventArgs e)
        {
